...
int main() {
/* print some text */
printf(" TTTT NUMBER TRIGGER_OFFSET(us) TIME_KTM_WOULD_HAVE_TRIGGERED(us) BEAM_ON_MEAN_VOLTAGE(mv) RESIDUAL_BEAM_MEAN_VOLTAGE(mv) TIME_SINCE_LAST_PULSER_FALLING_EDGE(us) VOLTAGE(mV)");
